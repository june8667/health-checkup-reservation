...
import { getMyReservations, cancelReservation, updateReservationNotes } from '../../api/reservations';
...
export default function MyReservations() {
  ...
  const updateNotesMutation = useMutation({
    mutationFn: ({ id, specialNotes }: { id: string; specialNotes: string }) =>
      updateReservationNotes(id, specialNotes),
    onSuccess: () => {
  ...
  const handleUpdate = (id: string, data: { specialNotes?: string }) => {
    if (data.specialNotes !== undefined) {
      updateNotesMutation.mutate({ id, specialNotes: data.specialNotes });
    }
  };
